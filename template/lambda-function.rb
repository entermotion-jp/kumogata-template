...
# http://docs.aws.amazon.com/lambda/latest/dg/API_CreateFunction.html#SSS-CreateFunction-request-Runtime
runtime = _valid_values(args[:runtime],
                        %w( nodejs nodejs4.3 nodejs6.10 java8 python2.7 python3.6
                            dotnetcore1.0 dotnetcore2.0 nodejs4.3-edge go1.x ), "nodejs")
